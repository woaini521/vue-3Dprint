...
<!--          <el-table-column type="index" width="50" align="center" label="序号"/>-->
          <template v-for="(item, key) in colums">
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-col v-if="key === 'homePic'">
                  <el-image :src="httpUrl + scope.row[key]" :preview-src-list="[httpUrl + scope.row[key]]" style="width: 50%;"></el-image>
                </el-col>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template slot-scope="scope">
                <el-button size="mini" type="info" @click="handleDownload(scope.$index, scope.row.gcodePath)">下载</el-button>
